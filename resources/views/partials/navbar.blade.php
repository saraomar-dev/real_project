    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                {{-- 1. Garden Plots (الكل) --}}
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('plots*') ? 'active fw-bold' : '' }}" href="{{ route('plots.index') }}">
                        <i class="bi bi-grid-3x3-gap"></i> Plots
                    </a>
                </li>

                {{-- 2. Seeds & Invoices (الكل) --}}
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('seeds*') ? 'active fw-bold' : '' }}" href="{{ route('seeds.index') }}">
                        <i class="bi bi-flower1"></i> Seeds
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-success" href="{{ route('invoices.index') }}">
                ...
                {{-- 3. Soil & Pests (الكل) --}}
                <li class="nav-item">
                    <a class="nav-link text-info" href="{{ route('soil.index') }}">
                        <i class="bi bi-moisture"></i> Soil
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger" href="{{ route('pest.index') }}">
                        <i class="bi bi-bug"></i> Pests
                    </a>
                </li>

                {{-- 4. Tools, Tasks & Shifts (شغل التيم) --}}
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/marketplace"><i class="bi bi-shop"></i> Market</a>
                </li>

                {{-- 5. للمزارع فقط: الدعوات --}}
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold text-dark" href="{{ route('dashboard.show') }}">📊 Dashboard</a>
                </li>
                <li class="nav-item">
            ...
            {{-- الجانب الأيمن: التنبيهات والبروفايل --}}
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                {{-- User Name & Profile --}}
                <li class="nav-item">
                    <a class="nav-link fw-bold text-dark" href="{{ route('users.show', auth()->id()) }}">
                        {{ auth()->user()->name }}
                    </a>
                </li>
